...
// From OpenFracture package with small edits to mass
public static class Fragmenter2
{
    /// <summary>
                                       ...
                                       ref int i)
    {
        ...
        var parentMass = sourceObject.GetComponent<Fracturable>().mass;
        ...
        for(int k = 0; k < meshes.Length; k++)
        {
            ...
            var parentRigidBody = sourceObject.GetComponent<Fracturable>();
            var rigidBody = fragment.GetComponent<Fracturable>();
